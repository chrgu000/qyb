...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/qyb/cooperation/">合作列表</a></li>
	...
	<form:form id="inputForm" modelAttribute="cooperation" action="${ctx}/qyb/cooperation/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label class="control-label">合作标题:</label>
			<div class="controls">
				<form:input path="code" htmlEscape="false" maxlength="50"/>
			</div>
		</div>
